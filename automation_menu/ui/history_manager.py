...
class HistoryManager:
    ...
    def get_history_tab( self, tabcontrol: ttk.Notebook, main_self ):
        ...
        item_start_title = ttk.Label( master = self.history_item_display, text = _( 'Started' ) )
        ...
        self.item_start = Text( master = self.history_item_display, height = 1, state = 'disabled' )
        self.item_start.grid( column = 1, row = 0, padx = 5, pady = 5, sticky = ( W, E ) )

        item_end_title = ttk.Label( master = self.history_item_display, text = _( 'Ended' ) )
        ...
        self.item_end = Text( master = self.history_item_display, height = 1, state = 'disabled' )
        self.item_end.grid( column = 1, row = 1, padx = 5, pady = 5, sticky = ( W, E ) )

        duration_title = ttk.Label( master = self.history_item_display, text = _( 'Duration' ) )
        ...
        self.duration = Text( master = self.history_item_display, height = 1, state = 'disabled' )
        self.duration.grid( column = 1, row = 2, padx = 5, pady = 5, sticky = ( W, E ) )

        item_output_title = ttk.Label( master = self.history_item_display, text = _( 'Generated output' ) )
        ...
        self.item_output = Text( master = self.history_item_display, state = 'disabled' )
